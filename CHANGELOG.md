...
- 【文档】：
  1. README 补充暂未声明许可证的公开说明，并修正一键启动默认端口为 `5184 / 8004 / 8014`。
  2. 新增 `docs/roadmap.md`，明确当前阶段、短期目标、中期目标、长期目标和暂不计划方向。
  3. 新增 `docs/real-data-source-design.md`，说明真实数据源接入边界、指标目录、权限校验、适配器和迁移步骤。
  4. 新增 `docs/code-quality-assessment.md`，评估当前代码质量、主要风险和优先治理顺序。

- 【工程】：
  1. 更新前端、Runtime 和 FastAPI 版本号为 `0.11.30`。
